    ...
    if (_alarmMode == ASM_DISABLED) {
      if (_alarmCount > 0) {
        if (_buzzer) {
          ...
          #if defined(CONFIG_GPIO_BUZZER) && (CONFIG_GPIO_BUZZER > -1)
            beepTaskSend(CONFIG_ALARM_BUZZER_DISABLED_WARNING_FREQUENCY, 0, 
              CONFIG_ALARM_BUZZER_DISABLED_WARNING_DURATION, 
              CONFIG_ALARM_BUZZER_DISABLED_WARNING_QUANTITY, 
              CONFIG_ALARM_BUZZER_DISABLED_WARNING_DUTY);
          #endif // CONFIG_GPIO_BUZZER
        };
      } else {
        if (_buzzer) {
          ...
          #if defined(CONFIG_GPIO_BUZZER) && (CONFIG_GPIO_BUZZER > -1)
            beepTaskSend(CONFIG_ALARM_BUZZER_DISABLED_NORMAL_FREQUENCY, 0,
              CONFIG_ALARM_BUZZER_DISABLED_NORMAL_DURATION, 
              CONFIG_ALARM_BUZZER_DISABLED_NORMAL_QUANTITY,
              CONFIG_ALARM_BUZZER_DISABLED_NORMAL_DUTY);
          #endif // CONFIG_GPIO_BUZZER
        };
      };
      ...
      if (_buzzer) {
        ...
        #if defined(CONFIG_GPIO_BUZZER) && (CONFIG_GPIO_BUZZER > -1)
          beepTaskSend(CONFIG_ALARM_BUZZER_ARMED_FREQUENCY, 0,
            CONFIG_ALARM_BUZZER_ARMED_DURATION, 
            CONFIG_ALARM_BUZZER_ARMED_QUANTITY,
            CONFIG_ALARM_BUZZER_ARMED_DUTY);
        #endif // CONFIG_GPIO_BUZZER
      };
    } else {
      if (_buzzer) {
        ...
        #if defined(CONFIG_GPIO_BUZZER) && (CONFIG_GPIO_BUZZER > -1)
          beepTaskSend(CONFIG_ALARM_BUZZER_PARTIAL_FREQUENCY, 0,
            CONFIG_ALARM_BUZZER_PARTIAL_DURATION, 
            CONFIG_ALARM_BUZZER_PARTIAL_QUANTITY,
            CONFIG_ALARM_BUZZER_PARTIAL_DUTY);
        #endif // CONFIG_GPIO_BUZZER
      };
    };
  };
...
static void alarmBuzzerAlarmOn()
{
  if (_alarmBuzzerEnabled) {
    if (_buzzer) {
      ...
      #if defined(CONFIG_GPIO_BUZZER) && (CONFIG_GPIO_BUZZER > -1)
        beepTaskSend(CONFIG_ALARM_BUZZER_ALARM_FREQUENCY, 0,
          CONFIG_ALARM_BUZZER_ALARM_DURATION, 
          CONFIG_ALARM_BUZZER_ALARM_QUANTITY,
          CONFIG_ALARM_BUZZER_ALARM_DUTY);
      #endif // CONFIG_GPIO_BUZZER
    };
  };
}
...
static void alarmBuzzerAlarmOff()
{
  if (_alarmBuzzerEnabled) {
    if (_buzzer) {
      ...
      #if defined(CONFIG_GPIO_BUZZER) && (CONFIG_GPIO_BUZZER > -1)
        beepTaskSend(CONFIG_ALARM_BUZZER_ALARM_CLEAR_FREQUENCY, 0,
          CONFIG_ALARM_BUZZER_ALARM_CLEAR_DURATION, 
          CONFIG_ALARM_BUZZER_ALARM_CLEAR_QUANTITY,
          CONFIG_ALARM_BUZZER_ALARM_CLEAR_DUTY);
      #endif // CONFIG_GPIO_BUZZER
    };
  };
}
